...
export const RabbitIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.21 0.293C9.0227 0.480528 8.99261 0.743503 9.11646 0.959081L14 9.5L11.1875 9.5C10.8644 9.5 10.5688 9.67375 10.4062 9.95L8.19 14H6.5V9.96722C6.5 9.73366 6.39464 9.51344 6.2175 9.36553L3.5 7.14925V4H1V6.5H2.24537L6.25 9.75V15.5H9.625L12.225 10.75H15.5V8.5L10 -0.5L9.21 0.293Z"
        fill="currentColor"
      />
      <path
        d="M2 11.5C2 12.3284 1.32843 13 0.5 13C0.223858 13 0 12.7761 0 12.5C0 12.2239 0.223858 12 0.5 12C0.776142 12 1 11.7761 1 11.5C1 11.2239 0.776142 11 0.5 11C0.223858 11 0 10.7761 0 10.5C0 10.2239 0.223858 10 0.5 10C1.32843 10 2 10.6716 2 11.5Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const LibraryIcon = ({ size = 16, className }: { size?: number; className?: string }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6.5 1H2C1.44772 1 1 1.44772 1 2V14C1 14.5523 1.44772 15 2 15H14C14.5523 15 15 14.5523 15 14V4.5C15 3.94772 14.5523 3.5 14 3.5H9.5V2C9.5 1.44772 9.05228 1 8.5 1H6.5ZM3 4.5H6.5V5.5H3V4.5ZM3 7.5H13V8.5H3V7.5ZM3 10.5H13V11.5H3V10.5Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const LightningIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.40799 0.637814C9.71288 0.376478 10.1992 0.572254 10.2432 0.981532L10.75 5H14.75C15.1149 5 15.3565 5.39116 15.1756 5.70797L9.67564 15.708C9.4576 16.1093 8.83847 15.9611 8.79175 15.5185L8 10H1.75C1.39117 10 1.14957 9.6232 1.31462 9.30562L7.81462 0.305617C7.96255 0.0252819 8.3269 -0.0786232 8.6316 0.0732514L9.40799 0.637814Z"
        fill="currentColor"
      />
    </svg>
  );
