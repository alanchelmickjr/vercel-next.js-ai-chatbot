...
/**
 * Memoized version of the Suggestion component to prevent unnecessary re-renders
 * Only re-renders when props change (suggestion, onApply, or artifactKind)
 */
export const Suggestion = memo(PureSuggestion);
